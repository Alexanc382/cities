...
def get_coordinates(city, key): # передадим в функцию аргументы из city и key
    try:
        ...
        # lat - широта, lng - долгота
            ...
            return f'Широта: {var_lat}\nДолгота: {var_lng}' # функция get_... возвращает нам координаты (55.625578, 37.6063916) по 'пути',
...
city = 'Коломна' # указываем город, координаты которого хотим запросить
